    ...
    createMenu(menu) {
        return new Promise(async (resolve, reject) => {
            try {
                ...
                const result = await rp({ method: 'POST', url: url, json: true, body: menu });

                console.log("createMenu 成功！")
                resolve(result);

            }
            catch (e) {
                reject('createMenu 出 error: ' + e)
            }
        })
    }
    ...
    deleteMenu() {
        return new Promise(async (resolve, reject) => {
            try {
                ...
                const result = await rp({ method: 'GET', url: url, json: true });

                console.log("deleteMenu 成功！")
                resolve(result);
            } catch (e) {
                reject('deleteMenu 出 error: ' + e)
            }
        })
    }
}
